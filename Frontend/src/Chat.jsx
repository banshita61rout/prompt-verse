...
function Chat() {
  const { messages, isLoading, editLastMessage, regenerateLast } = useContext(Mycontext);
  ...
  if (messages.length === 0 && !isLoading) {
    return (
      <div className="chat-empty">
        <span className="portal-mark large"></span>
          ...
          <div key={index} className={`msg-row ${msg.role}`}>
            <div className={`msg-avatar ${msg.role}`}>
              <span className="msg-avatar-inner">
                {msg.role === "user" ? "Y" : <span className="portal-mark small"></span>}
              </span>
            </div>
            <div className="msg-body">
              {msg.role === "user" && editing && index === lastUserIndex ? (
                <div className="edit-box">
                  ...
                  <div className="edit-actions">
                    ...
                    <button className="save" onClick={saveEdit}>Save & resend</button>
                  </div>
                </div>
              ) : (
              ...
              <div className="msg-actions">
                ...
                {msg.role === "assistant" && index === lastAssistantIndex && !isLoading && (
                  <button className="msg-action-btn" onClick={regenerateLast}>
                    <RotateCcw size={13} />
                    <span>Regenerate</span>
                  </button>
                )}
                {msg.role === "user" && index === lastUserIndex && !editing && !isLoading && (
        ...
        {isLoading && (
          <div className="msg-row assistant">
            <div className="msg-avatar assistant">
              <span className="msg-avatar-inner">
                <span className="portal-mark small"></span>
              </span>
            </div>
            <div className="msg-body">
              <ThinkingDots />
